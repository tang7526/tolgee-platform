...
const style = {
  ...
  create: _ref => {
    ...
    if (options.background) {
      ...
      Object.keys(legacy.color.collection).forEach(backgroundColor => {
        if (options.backgroundColors === undefined || options.backgroundColors.length === 0 || options.backgroundColors.indexOf(backgroundColor) !== -1) {
          ...
          let colorCollection = legacy.color.collection[backgroundColor];
    ...
    let seedInitials = initials(prng.seed.trim()).toLocaleUpperCase().slice(0, (_options$chars = options.chars) !== null && _options$chars !== void 0 ? _options$chars : defaults.chars);
