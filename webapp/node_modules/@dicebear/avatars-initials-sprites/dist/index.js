...
const style = {
  ...
  create: _ref => {
    ...
    let defaults = legacy.utils.schema.defaults(schema$1);
    ...
    if (options.background) {
      ...
      Object.keys(legacy__default["default"].color.collection).forEach(backgroundColor => {
        if (options.backgroundColors === undefined || options.backgroundColors.length === 0 || options.backgroundColors.indexOf(backgroundColor) !== -1) {
          ...
          let colorCollection = legacy__default["default"].color.collection[backgroundColor];
